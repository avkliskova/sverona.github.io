...
## Some aspects of combinatorial lattice theory
...
The primary references for this section are [@donnelly-poset-models] and
[@stanley-ec1].
...
Distributive Lattices (or *FTFDL*) by [@stanley-ec2].
...
The \"function\"[^1] \\(J\\) maps order ideals of \\(P\\) to elements in \\(L\\);
...
<figure>
DIAGRAM HERE
<figcaption>A typical diamond.</figcaption>
</figure>
...
::: proof
 See [@donnelly-poset-models], Proposition
13 and Theorem 14. 
:::
...
*monochromatic components*) play an important role in Chapter 3.

[^1]: We stop short of defining these as functions for technical
    reasons; strictly speaking, the \"set\" of all posets is actually a
    proper class.
